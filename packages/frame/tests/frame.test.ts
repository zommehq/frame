...
describe("Frame", () => {
  ...
  describe("initialization", () => {
    it("should require name and src attributes", () => {
      const emptyFrame = document.createElement("z-frame") as Frame;
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        "[z-frame] Missing required attributes: name and src",
      );
    ...
    it("should use default base path when not provided", () => {
      const frameWithoutBase = document.createElement("z-frame") as Frame;
  ...
  describe("sendToIframe", () => {
    ...
    it("should handle missing iframe", () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith("[z-frame] Iframe not ready");
      console.error = originalError;
    });
  });
});
