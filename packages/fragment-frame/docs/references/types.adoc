...
TypeScript types and interfaces for Fragment Frame.
...
[source,typescript]
----
import type { PostMessageFn } from '@zomme/fragment-frame/types';
...
[source,typescript]
----
import { ErrorMessages } from '@zomme/fragment-frame/constants';
...
[source,typescript]
----
import { WarningMessages } from '@zomme/fragment-frame/constants';
...
[source,typescript]
----
import type { Message, InitMessage, ReadyMessage } from '@zomme/fragment-frame/types';
import { MessageEvent } from '@zomme/fragment-frame/constants';
...
[source,typescript]
----
import { FragmentFrame } from '@zomme/fragment-frame';
