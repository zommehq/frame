...
This document describes all constant values used in Fragment Elements.
...
[source,typescript]
----
import { MessageEvent, FUNCTION_CALL_TIMEOUT, ERROR_MESSAGES } from '@micro-fe/fragment-elements/constants';
----
