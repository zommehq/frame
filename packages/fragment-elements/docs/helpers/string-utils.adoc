...
Helper functions for string case conversion used internally by Fragment Elements.
...
[source,typescript]
----
import { kebabCase, camelCase } from '@micro-fe/fragment-elements';
----
...
[source,typescript]
----
import { kebabCase } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { camelCase } from '@micro-fe/fragment-elements';
...
Fragment Elements uses these utilities to convert between HTML attribute names (kebab-case) and JavaScript property names (camelCase):
...
[source,typescript]
----
kebabCase('user@name')    // 'username'  (@ removed)
