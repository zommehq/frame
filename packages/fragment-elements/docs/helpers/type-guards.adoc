...
[source,typescript]
----
import { isMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isInitMessage, MessageEvent } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isReadyMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isAttributeChangeMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isEventMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isCustomEventMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isFunctionCallMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isFunctionResponseMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isFunctionReleaseMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isFunctionReleaseBatchMessage } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isValidEventName } from '@micro-fe/fragment-elements';
...
[source,typescript]
----
import { isSafeAttributeName } from '@micro-fe/fragment-elements';
